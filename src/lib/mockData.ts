...
const retentionCurve = [
  100, 96, 92, 88, 85, 82, 78, 74, 71, 68, 66, 65, 67, 70, 72, 71, 69, 66, 62, 58,
...
export const mockAnalysis: Analysis = {
  ...
  result: {
    ...
    strong_points: [
      {
        title: "Hook impactante nos primeiros 3 segundos",
        description:
          "Abre com uma afirmação polêmica que quebra padrões e gera curiosidade imediata.",
      },
      {
        title: "Título com promessa específica",
        description: "Inclui número exato e prazo, aumentando o CTR em redes sociais.",
      },
      {
        title: "Storytelling com vulnerabilidade",
        description: "Compartilha falhas pessoais antes da solução, criando conexão emocional.",
      },
      {
        title: "Ritmo de edição dinâmico",
        description: "Cortes a cada 2-3 segundos mantêm a atenção do espectador moderno.",
      },
      {
        title: "CTA contextualizado",
        description: "A chamada para ação aparece no momento de maior engajamento, não no fim.",
      },
    ],
    weak_points: [
      {
        ...
        suggestion:
          "Quebre em duas partes com um padrão de interrupção (pergunta, mudança de cenário).",
      },
      {
    ...
    mental_triggers: [
      {
        name: "Curiosidade",
        description: "Abre loop narrativo no início que só fecha aos 4 minutos.",
        timestamp: "0:03",
      },
      {
        name: "Urgência",
        description: "Menciona oportunidade limitada no nicho atual.",
        timestamp: "1:24",
      },
      {
        name: "Prova Social",
        description: "Mostra prints de alunos com resultados reais.",
        timestamp: "3:10",
      },
      {
        name: "Antecipação",
        description: "Promete revelar segredo apenas no final.",
        timestamp: "5:00",
      },
    ],
    transcript: [
      {
        timestamp: "0:00",
        text: "Se você trabalha 8 horas por dia e ainda assim não sobra dinheiro, esse vídeo é pra você.",
        type: "hook",
      },
      {
        timestamp: "0:12",
        text: "Há dois anos eu estava exatamente onde você está agora.",
        type: "normal",
      },
      {
        timestamp: "0:34",
        text: "Mas descobri uma coisa que mudou tudo — e não é o que você pensa.",
        type: "highlight",
      },
      {
        timestamp: "1:02",
        text: "A primeira coisa que precisa entender é a matemática do tempo livre.",
        type: "normal",
      },
      {
        timestamp: "1:48",
        text: "Olha esse print: R$ 13.247 no último mês trabalhando do sofá.",
        type: "highlight",
      },
      {
        timestamp: "2:30",
        text: "Existem três pilares que sustentam qualquer renda alta com pouco tempo.",
        type: "normal",
      },
      {
        timestamp: "3:15",
        text: "Veja o resultado da Maria, ela aplicou e em 60 dias dobrou a renda.",
        type: "highlight",
      },
      {
        timestamp: "3:58",
        text: "O segundo pilar é o que mais gente erra — e eu cometi por anos.",
        type: "normal",
      },
      {
        timestamp: "4:45",
        text: "Anota essa frase: produtividade não é fazer mais, é fazer o certo.",
        type: "highlight",
      },
      {
        timestamp: "5:20",
        text: "Agora vou te entregar o terceiro pilar, o que ninguém fala.",
        type: "normal",
      },
      {
        timestamp: "5:42",
        text: "Se isso te ajudou, deixa o like e se inscreve, isso me ajuda demais.",
        type: "cta",
      },
    ...
    new_title_suggestion:
      "Eu trabalhava 12 horas por dia e ainda assim faltava dinheiro — até descobrir isso",
    hook_suggestions: [
